...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _goal_startDate=[NSDate stringFromDate:[[NSDate date] dayInTheFollowingDay:3]];
...
-(void)initAllProperties
{
    ...
    self.goal_startDate=[NSDate stringFromDate:[[NSDate date] dayInTheFollowingDay:3]];
...
//
    ...
    self.goal_startDate=detailModel.detailProductModel.start_time?detailModel.detailProductModel.start_time:[NSDate stringFromDate:[[NSDate date] dayInTheFollowingDay:3]];
    self.goal_backDate=detailModel.detailProductModel.end_time?detailModel.detailProductModel.end_time:[NSDate stringFromDate:[[NSDate date] dayInTheFollowingDay:3]];
...
//    self.raiseMoney_imgsDes
    ...
    self.raiseMoney_voiceLen=detailModel.detailProductModel.productVoiceLen;
...
//                self.goal_numberPeople=reportModel.people>0?[NSString stringWithFormat:@"%@",reportModel.people]:nil;
                ...
                self.return_voiceLen=reportModel.spellVoiceLen;
            ...
            else if ([reportModel.style isEqual:@4])
            {
                ...
                self.return_togtherVoiceLen=reportModel.spellVoiceLen;
