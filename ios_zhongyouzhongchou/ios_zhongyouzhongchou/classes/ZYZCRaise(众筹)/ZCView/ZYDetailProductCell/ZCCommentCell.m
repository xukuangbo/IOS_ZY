...
-(void)configUI
{
    ...
    _timeLab=[self createLabWithFrame:CGRectMake(KSCREEN_W-KEDGE_DISTANCE-130, KEDGE_DISTANCE, 130, 20) andFont:[UIFont systemFontOfSize:12] andTitleColor:[UIColor ZYZC_TextGrayColor]];
    _timeLab.textAlignment=NSTextAlignmentRight;
    [self.contentView addSubview:_timeLab];
    
    _contentLab= [self createLabWithFrame:CGRectMake(_iconBtn.right+KEDGE_DISTANCE, _nameLab.bottom+KEDGE_DISTANCE, KSCREEN_W-_iconBtn.right-2*KEDGE_DISTANCE, 20) andFont:[UIFont systemFontOfSize:15] andTitleColor:[UIColor ZYZC_TextBlackColor]];
