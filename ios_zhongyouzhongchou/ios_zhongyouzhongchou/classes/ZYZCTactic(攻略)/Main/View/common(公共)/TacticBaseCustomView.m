...
@implementation TacticBaseCustomView
+ (instancetype)viewWithMaxCount:(NSInteger )maxCount;
{
    return [[self alloc] initWithFrame:CGRectMake(KEDGE_DISTANCE, 0, KSCREEN_W - 2 * KEDGE_DISTANCE, kTacticViewMapHeight(maxCount))];
